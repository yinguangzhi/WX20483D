System.register([], function (_export, _context) {
  ...
  function onGameStarted(cc, settings) {
    ...
    window.launchScene = settings.launchScene;

    cc.director.preloadScene(window.launchScene, null, () => {

      window.couldGoToGame = true;
  ...
  // window.customEnterGame = function () {
     
  //       if (window.isFacebookReady && window.isCocosEngineReady) { }
  // }
  
  window.realGoGameFromIndex = function () {
        window.hasGoToGame = true;
        // window.couldGoToGame = false;

        cc.director.loadScene(window.launchScene, null, function () {
